        ...
        <>
          ...
          {attivita.commit.length === 0 ? (
            ...
            attivita.commit.slice(0, 8).map((c) => (
              ...
              >
                <code className="flex-none text-xxs text-faint">{c.sha}</code>
                <span className="min-w-0 flex-1 truncate text-xs">{c.messaggio}</span>
                <span className="flex-none text-xxs text-faint">{c.autore}</span>
              </a>
            ))
          )}
        </>
