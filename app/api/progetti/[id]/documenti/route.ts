...
/** Limite per file: oltre, il caricamento viene rifiutato con un messaggio. */
...
export async function POST(
  ...
  // La chiave include un UUID: due file con lo stesso nome non si sovrascrivono.
  const chiave = `progetti/${id}/${randomUUID()}-${file.name}`;
  ...
  await registraEvento(id, "documento", `Documento caricato: ${doc.nome}`, {
